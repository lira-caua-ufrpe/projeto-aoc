...
msg_err_valor_maior:     .asciiz "Falha: valor fornecido maior que a dÃƒÂ­vida do cartÃƒÂ£o\n"
...
msg_err_saldo_devedor:   .asciiz "Falha: saldo devedor ainda nÃ£o quitado. Saldo da conta corrente: R$ "
msg_err_limite_devido:   .asciiz "Falha: limite de crÃ©dito devido. Limite de crÃ©dito: R$ "
msg_err_cpf_nao_cadastrado: .asciiz "Falha: CPF nÃ£o possui cadastro.\n"
