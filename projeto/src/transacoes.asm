...
formatar_centavos:
    ...
    # vamos usar parte final do buffer pra guardar dígitos ao contrário
    addiu $s3, $s0, 24   # área temporária dentro do próprio buffer
    move  $t2, $s3       # ptr temp
...
fc_copy_back:
    # t2 aponta 1 alem do ultimo digito
    addiu $t2, $t2, -1
fc_copy_loop:
    lb    $t4, 0($t2)
    sb    $t4, 0($s1)
